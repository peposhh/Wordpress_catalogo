			...
			array(
				...
				'fields'          => array(
					array(
						'type'    => 'notice',
						'style'   => 'normal',
						'content' => __( 'To unlock the following typography(900+ Google Fonts) options, <a href="https://shapedplugin.com/plugin/woocommerce-category-slider-pro/?ref=115" target="_blank"><b>Upgrade to Pro!</b></a>', 'woo-category-slider-grid' ),
					),
					array(
