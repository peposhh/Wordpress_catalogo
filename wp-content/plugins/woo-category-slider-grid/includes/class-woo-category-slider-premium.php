...
class Woo_Category_Slider_Premium {
	...
	public function premium_page() {
		add_submenu_page( 'edit.php?post_type=sp_wcslider', __( 'Category Slider for WooCommerce Premium', 'woo-category-slider-grid' ), __( 'Premium', 'woo-category-slider-grid' ), 'manage_options', 'wcsp_premium', array( $this, 'premium_page_callback' ) );
	}
	/**
	 * Happy users.
	 *
	...
	public function happy_users( $username = 'shapedplugin', $args = array() ) {
		if ( $username ) {
			...
			$data = array(
				'error' => __( 'No data found!', 'woo-category-slider-grid' ),
			);
		}
				...
				<div class="row">
					<div class="sp-wcsp-col-xl-6">
						<div class="sp-wcsp-banner-content">
							<h2 class="sp-wcsp-font-30 main-color sp-wcsp-font-weight-500"><?php esc_html_e( 'Upgrade To WooCommerce Category Slider Pro', 'woo-category-slider-grid' ); ?></h2>
					...
					<div class="sp-wcsp-col-xl-6">
						<div class="sp-wcsp-banner-img">
							<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/boost-sales-wcs.svg'; ?>" alt="">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="sp-wcsp-count-area">
					...
					<div class="count-item">
						...
						if ( isset( $plugin_data['plugins'] ) ) {
							...
							echo esc_attr( $plugin_downloads['http://wordpress.org/plugins/woo-category-slider-grid'] );
						} else {
							echo '92000';
						}
						?>
					...
					<div class="count-item">
						...
						if ( isset( $plugin_data['plugins'] ) ) {
							...
							echo esc_attr( $plugin_rating['http://wordpress.org/plugins/woo-category-slider-grid'] ) . '/5';
						} else {
							echo '4.9/5';
						}
						?>
		...
		<section class="sp-wcsp-video">
			<div class="sp-wcsp-container">
				...
				<div class="video-area text-center">
					<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/learn-how-to-boost-sales.svg'; ?>" alt="">
			...
			<div class="sp-wcsp-container">
				...
				<div class="feature-wrapper">
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/1.svg'; ?>" alt="">
							</div>
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="
								<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/wcs-icon.svg'; ?>
								" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="
								<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/custom.svg'; ?>
								" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/easy.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/specific.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/child-cat.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/slider-grid.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/layout.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/typography.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/slider-control.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/multisite.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/flat-icon.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/page-bilder.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_WCS_URL ) . 'admin/css/images/premium/support.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
