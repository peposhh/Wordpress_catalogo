		...
		<table class="shop_table cart  shop_table_responsive" id="yith-ywrq-table-list" cellspacing="0">
			...
			<tr>
				...
				<th class="product-name"
					colspan="<?php echo esc_attr( $product_column_colspan ); ?>"><?php esc_html_e( 'Producto', 'yith-woocommerce-request-a-quote' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Cantidad', 'yith-woocommerce-request-a-quote' ); ?></th>
				<?php if ( ! $hide_price ) : ?>
