...
<div class="yith-ywraq-mail-form-wrapper">
	<h3><?php esc_html_e( 'Enviar la solicitud de cotización', 'yith-woocommerce-request-a-quote' ); ?></h3>
	...
	<form id="yith-ywraq-mail-form" name="yith-ywraq-mail-form" action="<?php echo esc_url( YITH_Request_Quote()->get_raq_page_url() ); ?>" method="post">
			...
			<p class="form-row form-row-wide validate-required " id="rqa_name_row">
				<label for="rqa-name" class=""><?php esc_html_e( 'Nombre', 'yith-woocommerce-request-a-quote' ); ?>
		...
		<p class="form-row" id="rqa_message_row">
			<label for="rqa-message" class=""><?php esc_html_e( 'Mensaje', 'yith-woocommerce-request-a-quote' ); ?></label>
			<textarea name="rqa_message" class="input-text " id="rqa-message" placeholder="<?php esc_html_e( 'Comentarios de tu solicitud...', 'yith-woocommerce-request-a-quote' ); ?>" rows="5" cols="5"></textarea>
		</p>
		...
		<p class="form-row">
			...
			<input class="button raq-send-request" type="submit" value="<?php esc_html_e( 'Enviar Cotización', 'yith-woocommerce-request-a-quote' ); ?>">
		</p>
