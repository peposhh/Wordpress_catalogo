			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'type'       => 'color',
						'title'      => __( 'Category Name Color', 'woo-category-slider-grid' ),
						'subtitle'   => __( 'Set category name color.', 'woo-category-slider-grid' ),
						'default'    => '#444444',
						'dependency' => array(
							'wcsp_cat_name',
							'==',
					...
					array(
						...
						'type'       => 'color',
						'title'      => __( 'Product Count Color', 'woo-category-slider-grid' ),
						'subtitle'   => __( 'Set product count color.', 'woo-category-slider-grid' ),
						'default'    => '#777777',
						'dependency' => array(
					...
					array(
						...
						'type'       => 'color',
						'title'      => __( 'Description Color', 'woo-category-slider-grid' ),
						'subtitle'   => __( 'Set description color.', 'woo-category-slider-grid' ),
						'default'    => '#444444',
						'dependency' => array(
